...
const rawDirectoryTools: DirectoryTool[] = [
  ...
  { name: "Word Counter", description: "Count words quickly", category: "Text", href: "/tools/code-checker", iconName: "fileText", accent: "text-cyan-600 bg-cyan-50" },
  { name: "Character Counter", description: "Count characters", category: "Text", href: "/tools/code-checker", iconName: "fileText", accent: "text-emerald-600 bg-emerald-50" },
